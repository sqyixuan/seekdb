...
int main(int argc, char **argv)
{
  oceanbase::unittest::ObObjectStorageUnittestUtil::generate_configs_with_checksum(
    ...
    oceanbase::unittest::Config {
      "GCS",                              /*storage_type*/
      oceanbase::unittest::GCS_BUCKET2,    /*bucket*/
      oceanbase::unittest::GCS_ENDPOINT2,  /*enpoint*/
      oceanbase::unittest::GCS_AK2,        /*ak*/
      oceanbase::unittest::GCS_SK2,        /*sk*/
    },
    {nullptr}
  );
  oceanbase::unittest::ObObjectStorageUnittestUtil::generate_configs_with_checksum(
  ...
  system("rm -f test_object_storage_list_gcs.log*");
  OB_LOGGER.set_file_name("test_object_storage_list_gcs.log", true, true);
