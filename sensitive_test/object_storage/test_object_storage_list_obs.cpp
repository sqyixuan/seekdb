...
int main(int argc, char **argv)
{
  oceanbase::unittest::ObObjectStorageUnittestUtil::generate_configs_with_checksum(
    ...
    oceanbase::unittest::Config {
      "OBS",                              /*storage_type*/
      oceanbase::unittest::OBS_BUCKET2,    /*bucket*/
      oceanbase::unittest::OBS_ENDPOINT2,  /*enpoint*/
      oceanbase::unittest::OBS_AK2,        /*ak*/
      oceanbase::unittest::OBS_SK2,        /*sk*/
      nullptr,                            /*region*/
      nullptr,                            /*appid*/
      nullptr,                            /*entension*/
    },
  ...
  system("rm -f test_object_storage_list_obs.log*");
  OB_LOGGER.set_file_name("test_object_storage_list_obs.log", true, true);
