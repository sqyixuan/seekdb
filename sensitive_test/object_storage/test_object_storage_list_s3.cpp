...
int main(int argc, char **argv)
{
  oceanbase::unittest::ObObjectStorageUnittestUtil::generate_configs_with_checksum(
    ...
    oceanbase::unittest::Config {
      "S3",                               /*storage_type*/
      oceanbase::unittest::S3_BUCKET2,     /*bucket*/
      oceanbase::unittest::S3_ENDPOINT2,   /*enpoint*/
      oceanbase::unittest::S3_AK2,         /*ak*/
      oceanbase::unittest::S3_SK2,         /*sk*/
      oceanbase::unittest::S3_REGION2,     /*region*/
      nullptr,                            /*appid*/
      nullptr,                            /*entension*/
    },
    {nullptr}
  ...
  system("rm -f test_object_storage_list_s3.log*");
  OB_LOGGER.set_file_name("test_object_storage_list_s3.log", true, true);
