    ...
    */
    {
      ...
      } else if (info_base_.get_type() == ObStorageType::OB_STORAGE_COS || info_base_.get_type() == ObStorageType::OB_STORAGE_OSS) {
        ASSERT_TRUE(contains_all(op.object_list_, dirs));
      }
    }
