...
int main(int argc, char **argv)
{
  oceanbase::unittest::ObObjectStorageUnittestUtil::generate_configs_with_checksum(
    ...
    oceanbase::unittest::Config {
      "AZBLOB",                               /*storage_type*/
      oceanbase::unittest::AZBLOB_BUCKET2,     /*bucket*/
      oceanbase::unittest::AZBLOB_ENDPOINT2,   /*enpoint*/
      oceanbase::unittest::AZBLOB_AK2,         /*ak*/
      oceanbase::unittest::AZBLOB_SK2,         /*sk*/
    },
    {nullptr}
  );

  system("rm -f test_object_storage_list_azblob.log*");
  OB_LOGGER.set_file_name("test_object_storage_list_azblob.log", true, true);
