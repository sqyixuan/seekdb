...
int main(int argc, char **argv)
{
  oceanbase::unittest::ObObjectStorageUnittestUtil::generate_configs_with_checksum(
    ...
    oceanbase::unittest::Config {
      "COS",                              /*storage_type*/
      oceanbase::unittest::COS_BUCKET2,    /*bucket*/
      oceanbase::unittest::COS_ENDPOINT2,  /*enpoint*/
      oceanbase::unittest::COS_AK2,        /*ak*/
      oceanbase::unittest::COS_SK2,        /*sk*/
      nullptr,                            /*region*/
      oceanbase::unittest::COS_APPID2,     /*appid*/
      nullptr,                            /*entension*/
    },
    {nullptr}
  );
  ...
  system("rm -f test_object_storage_list_cos.log*");
  OB_LOGGER.set_file_name("test_object_storage_list_cos.log", true, true);
