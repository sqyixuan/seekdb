...
elseif(WIN32)
  set(OB_CC "clang-cl")
  set(OB_CXX "clang-cl")
  # Disable unnecessary Windows headers to reduce compile time
...
if (OB_USE_CLANG)
  ...
  elseif(WIN32)
    ...
    # clang-cl uses MSVC-style flags, convert GNU flags to MSVC equivalents
    # /Oy- = keep frame pointer (equivalent to -fno-omit-frame-pointer)
    # compiler-rt for __udivti3: linked explicitly in observer CMakeLists (rtlib doesn't work with lld-link)
