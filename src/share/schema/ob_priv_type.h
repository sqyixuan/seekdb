...
#define OB_PRIV_ALL                                                             \
  (OB_PRIV_ALTER | OB_PRIV_CREATE | OB_PRIV_CREATE_USER | OB_PRIV_DELETE |      \
   ...
   OB_PRIV_USE_CATALOG | OB_PRIV_LOCK_TABLE |        \
   OB_PRIV_CREATE_AI_MODEL | OB_PRIV_ALTER_AI_MODEL |     \
   OB_PRIV_DROP_AI_MODEL | OB_PRIV_ACCESS_AI_MODEL | OB_PRIV_CREATE_LOCATION)
...
enum OB_PRIV_OTHERS_TYPE
{
  ...
  OB_PRIV_OTHERS_CREATE_AI_MODEL = (1LL << 16),
  OB_PRIV_OTHERS_ALTER_AI_MODEL = (1LL << 17),
  OB_PRIV_OTHERS_DROP_AI_MODEL = (1LL << 18),
  OB_PRIV_OTHERS_ACCESS_AI_MODEL = (1LL << 19),
  OB_PRIV_OTHERS_CREATE_LOCATION = (1LL << 20)
};
