...
private :
  ...
  int parse_query_string_fields(ObIJsonBase &req_node, ObEsQueryInfo &query_info, bool semantic_query=false);
  ...
  int construct_hybrid_query(ObQueryReqFromJson *fts, ObQueryReqFromJson *knn, ObQueryReqFromJson *&hybrid, bool is_semantic_query = false);
  ...
  int set_output_columns(ObQueryReqFromJson &query_res, bool is_hybrid, bool include_inner_column = true, bool is_semantic_query = false);
  ...
  int construct_rank_query(ObString &sub_query_name, ObReqExpr *order_expr, ObString &rank_alias, ObQueryReqFromJson *&query_req, bool is_semantic_query = false);
  ...
  int set_semantic_distance_score_expr(const ObVectorIndexDistAlgorithm alg_type, ObReqConstExpr *&norm_const,
                                      ObReqExpr *&dist_vec, ObReqOpExpr *&add_expr, ObReqOpExpr *&score_expr);
  int construct_semantic_ip_expr(ObReqColumnExpr *hybrid_vec_field,
                                 ObReqConstExpr *query_str, ObReqCaseWhenExpr *&case_when/* score */,
                                 ObReqOpExpr *&minus_expr/* distance */, ObReqExpr *&order_by_4ip);
  int parse_semantic_knn(ObIJsonBase &req_node, ObQueryReqFromJson *&query_req);
  int parse_semantic_query(ObIJsonBase &req_node,
                           ObQueryReqFromJson *&query_req,
                           ObQueryReqFromJson *&knn_req);
  int parse_semantic_query_string(ObIJsonBase &req_node, ObQueryReqFromJson *&query_req);
  int parse_semantic_query_string(ObIJsonBase &req_node, ObEsQueryInfo &query_info);
  ObIAllocator &alloc_;
