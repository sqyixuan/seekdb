...
const uint64_t OB_GV_OB_HNSW_INDEX_INFO_TID = 21681; // "GV$OB_HNSW_INDEX_INFO"
const uint64_t OB_V_OB_HNSW_INDEX_INFO_TID = 21682; // "V$OB_HNSW_INDEX_INFO"
const uint64_t OB_GV_OB_IVF_INDEX_INFO_TID = 21683; // "GV$OB_IVF_INDEX_INFO"
const uint64_t OB_V_OB_IVF_INDEX_INFO_TID = 21684; // "V$OB_IVF_INDEX_INFO"
...
const char *const OB_GV_OB_HNSW_INDEX_INFO_TNAME = "GV$OB_HNSW_INDEX_INFO";
const char *const OB_V_OB_HNSW_INDEX_INFO_TNAME = "V$OB_HNSW_INDEX_INFO";
const char *const OB_GV_OB_IVF_INDEX_INFO_TNAME = "GV$OB_IVF_INDEX_INFO";
const char *const OB_V_OB_IVF_INDEX_INFO_TNAME = "V$OB_IVF_INDEX_INFO";
