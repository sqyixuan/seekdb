...
const uint64_t OB_ALL_VIRTUAL_CHANGE_STREAM_REFRESH_STAT_TID = 12560; // "__all_virtual_change_stream_refresh_stat"
...
const uint64_t OB_DBA_OB_CHANGE_STREAM_REFRESH_STAT_TID = 21667; // "DBA_OB_CHANGE_STREAM_REFRESH_STAT"
