...
const int64_t OB_SYS_TABLE_COUNT = 186;
const int64_t OB_VIRTUAL_TABLE_COUNT = 389;
const int64_t OB_SYS_VIEW_COUNT = 423;
const int64_t OB_SYS_TENANT_TABLE_COUNT = 1003;
const int64_t OB_CORE_SCHEMA_VERSION = 1;
const int64_t OB_BOOTSTRAP_SCHEMA_VERSION = 1006;
