...
const int64_t OB_SYS_TABLE_COUNT = 188;
const int64_t OB_VIRTUAL_TABLE_COUNT = 392;
const int64_t OB_SYS_VIEW_COUNT = 427;
const int64_t OB_SYS_TENANT_TABLE_COUNT = 1012;
const int64_t OB_CORE_SCHEMA_VERSION = 1;
const int64_t OB_BOOTSTRAP_SCHEMA_VERSION = 1015;
