...
const int64_t OB_SYS_TABLE_COUNT = 202;
const int64_t OB_VIRTUAL_TABLE_COUNT = 390;
const int64_t OB_SYS_VIEW_COUNT = 438;
const int64_t OB_SYS_TENANT_TABLE_COUNT = 1035;
const int64_t OB_CORE_SCHEMA_VERSION = 1;
const int64_t OB_BOOTSTRAP_SCHEMA_VERSION = 1038;
