...
inline const char *SQLITE_CREATE_TABLE_RESERVED_SNAPSHOT = 
  ...
  "  PRIMARY KEY (tenant_id, snapshot_type, svr_ip, svr_port)\n"
  ");";
...
inline const char *SQLITE_CREATE_TABLE_SERVER_EVENT_HISTORY = 
  ...
  "  svr_ip TEXT NOT NULL DEFAULT '',\n"
  "  svr_port INTEGER NOT NULL DEFAULT 0,\n"
  ...
  "  PRIMARY KEY (event_type, gmt_create, svr_ip, svr_port)\n"
  ");";
...
inline const char *SQLITE_CREATE_TABLE_COLUMN_CHECKSUM_ERROR_INFO = 
  ...
  "  PRIMARY KEY (tenant_id, frozen_scn, index_type, data_table_id, index_table_id, data_tablet_id, index_tablet_id)\n"
  ");";
...
inline const char *SQLITE_CREATE_TABLE_DEADLOCK_EVENT_HISTORY = 
  ...
  "  PRIMARY KEY (tenant_id, event_id, svr_ip, svr_port, detector_id)\n"
  ");";
...
inline const char *SQLITE_CREATE_TABLE_TABLET_META_TABLE = 
  ...
  "  PRIMARY KEY (tenant_id, tablet_id, ls_id, svr_ip, svr_port)\n"
  ");";
...
inline const char *SQLITE_CREATE_TABLE_TABLET_REPLICA_CHECKSUM = 
  ...
  "  PRIMARY KEY (tenant_id, tablet_id, svr_ip, svr_port, ls_id)\n"
  ");";
...
inline const char *SQLITE_CREATE_TABLE_TENANT_EVENT_HISTORY = 
  ...
  "  error_msg TEXT NULL,\n"
  "  PRIMARY KEY (tenant_id, gmt_create, svr_ip, svr_port)\n"
  ");";
