...
DEF_PARAM(min_observer_version, STR, OB_CLUSTER_PARAMETER, "1.1.0.0", "the min observer version",
        ObParameterAttr(Section::ROOT_SERVICE, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_PARAM(compatible, VERSION, OB_CLUSTER_PARAMETER, "1.1.0.0", "compatible version for persisted data",
            ObParameterAttr(Section::ROOT_SERVICE, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
