...
DEF_PARAM(datafile_size, CAP, OB_CLUSTER_PARAMETER, "2G", "[0M,)", "size of the data file. Range: [0, +∞)",
        ObParameterAttr(Section::SSTABLE, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_PARAM(datafile_next, CAP, OB_CLUSTER_PARAMETER, "2G", "[0M,)", "the auto extend step. Range: [0, +∞)",
        ObParameterAttr(Section::SSTABLE, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
...
DEF_PARAM(obconfig_url, STR, OB_CLUSTER_PARAMETER, "", "URL for OBConfig service",
        ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_PARAM(syslog_level, LOG_LEVEL, OB_CLUSTER_PARAMETER, "WDIAG", "specifies the current level of logging. There are DEBUG, TRACE, WDIAG, EDIAG, INFO, WARN, ERROR, seven different log levels.",
              ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE),
...
DEF_PARAM(diag_syslog_per_error_limit, INT, OB_CLUSTER_PARAMETER, "200", "[0,]",
        ...
        ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_PARAM(max_syslog_file_count, INT_WITH_CHECKER, OB_CLUSTER_PARAMETER, "4", common::ObConfigMaxSyslogFileCountChecker,
...
DEF_PARAM(tablet_meta_table_scan_batch_count, INT, OB_CLUSTER_PARAMETER, "999", "(0, 65536]",
        ...
        "Range:(0,65536]",
        ObParameterAttr(Section::ROOT_SERVICE, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_PARAM(ls_meta_table_check_interval, TIME, OB_CLUSTER_PARAMETER, "1s", "[1ms,)",
...
DEF_PARAM(min_observer_version, STR, OB_CLUSTER_PARAMETER, "1.0.0.0", "the min observer version",
        ObParameterAttr(Section::ROOT_SERVICE, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_PARAM(compatible, VERSION, OB_CLUSTER_PARAMETER, "1.0.0.0", "compatible version for persisted data",
            ObParameterAttr(Section::ROOT_SERVICE, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
...
DEF_PARAM(log_disk_size, CAP, OB_CLUSTER_PARAMETER, "2G", "[0M,)",
...
DEF_PARAM(log_disk_utilization_threshold, INT, OB_CLUSTER_PARAMETER,"80",
        "[10, 100)",
...
#ifdef ERRSIM
DEF_PARAM(errsim_ddl_sim_point_random_control, INT_LIST, OB_CLUSTER_PARAMETER, "",
        "the ddl sim point param in errsim mode, once set successfully, no more modifications"
        "format like: seed; point_count_per_task",
        ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_PARAM(errsim_ddl_sim_point_fixed_list, INT_LIST, OB_CLUSTER_PARAMETER, "",
        "the fixed ddl sim point list in errsim mode, "
        "format like: point_id_1; point_id_2; point_id_3",
        ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_PARAM(errsim_max_backup_retry_count, INT, OB_CLUSTER_PARAMETER, "0", "[0,)",
        "max backup retry count in errsim mode"
        "Range: [0,) in integer",
        ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_PARAM(errsim_max_backup_meta_retry_time_interval, TIME, OB_CLUSTER_PARAMETER, "10s", "[1s,5m]",
        "max backup meta retry time interval in errsim mode"
        "Range: [1s, 5m]",
        ObParameterAttr(Section::ROOT_SERVICE, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_PARAM(errsim_storage_meta_macro_ids_threshold, INT, OB_CLUSTER_PARAMETER, "0", "[0,)",
        "the threshold value that macro block list is stored by linked way in storage meta. "
        "Range: [0,) in integer",
        ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_PARAM(errsim_tablet_batch_count, INT, OB_CLUSTER_PARAMETER, "0", "[0,)",
        "batch tablet count when in errsim mode"
        "Range: [0,) in integer",
        ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_PARAM(errsim_large_co_sstable_threshold, INT, OB_CLUSTER_PARAMETER, "0", "[0, 1966080]",
        "large_co_sstable size threshold (byte) when in errsim mode"
        "Range: [0, 1966080] in integer",
        ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_PARAM(errsim_backup_ls_id, INT, OB_CLUSTER_PARAMETER, "0", "[0,)",
        "the ls id that backup want to insert error"
        "Range: [0,) in integer",
        ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_PARAM(errsim_backup_tablet_id, INT, OB_CLUSTER_PARAMETER, "0", "[0,)",
        "the tablet id that backup want to insert error"
        "Range: [0,) in integer",
        ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_PARAM(errsim_backup_task_id, INT, OB_CLUSTER_PARAMETER, "0", "[0,)",
        "the task id that backup want to insert error"
        "Range: [0,) in integer",
        ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_PARAM(errsim_transfer_ls_id, INT, OB_CLUSTER_PARAMETER, "0", "[0,)",
        "the ls id that transfer want to insert error"
        "Range: [0,) in integer",
        ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_PARAM(skip_report_pg_backup_task_table_id, INT, OB_CLUSTER_PARAMETER, "0", "[0,)",
        "skip_report_pg_backup_task table id"
        "Range: [0,) in integer",
        ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_PARAM(fake_once_init_restore_macro_index_store, INT, OB_CLUSTER_PARAMETER, "0", "[0,)",
        "0 for not fake, 1 for major, 2 for minor"
        "Range: [0,) in integer",
        ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_PARAM(enable_disk_error_test, BOOL, OB_CLUSTER_PARAMETER, "False",
         "when disk error test mode is enabled, observer send disk error "
         "status to rs in lease request",
         ObParameterAttr(Section::ROOT_SERVICE, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_PARAM(skip_update_estimator, BOOL, OB_CLUSTER_PARAMETER, "False",
         "skip update_estimator during daily merge. ",
         ObParameterAttr(Section::DAILY_MERGE, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_PARAM(with_new_migrated_replica, BOOL, OB_CLUSTER_PARAMETER, "False",
         "it is new migrated replica, can not be removed by old migration. ",
         ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_PARAM(sys_bkgd_migration_large_task_threshold, TIME, OB_CLUSTER_PARAMETER, "2h", "[0s,24h]",
         "the timeout for migration change member list retry. "
         "The default value is 2h. Range: [0s,24h]",
         ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_PARAM(macro_block_builder_errsim_flag, INT, OB_CLUSTER_PARAMETER, "0", "[0,100]",
        "macro_block_builder_errsim_flag"
        "Range: [0,100] in integer",
        ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_PARAM(skip_balance_disk_limit, BOOL, OB_CLUSTER_PARAMETER, "False",
         "skip_dbalance_isk_limit. ",
         ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_PARAM(pwrite_errsim, BOOL, OB_CLUSTER_PARAMETER, "False",
         "pwrite_errsim",
         ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_PARAM(fake_disk_error, BOOL, OB_CLUSTER_PARAMETER, "False",
         "fake_disk_error",
         ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_PARAM(_max_block_per_backup_task, INT, OB_CLUSTER_PARAMETER, "0", "[0,)",
        "the max macro block count per backup sub task"
        "Range: [0,max) in integer",
        ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_PARAM(backup_lease_takeover_time, TIME, OB_CLUSTER_PARAMETER, "10s", "[1s, 5m]",
         "Lease Takeover Time for Rootserver Backup heartbeat. Range: [1s, 5m]",
         ObParameterAttr(Section::ROOT_SERVICE, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_PARAM(trigger_auto_backup_delete_interval, TIME, OB_CLUSTER_PARAMETER, "1h", "[1s,)",
         "trigger auto backup delete interval."
         "The default value is 1h. Range: [1s,)",
         ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_PARAM(errsim_max_restore_retry_count, INT, OB_CLUSTER_PARAMETER, "0", "[0,)",
        "max restore retry count in errsim mode"
        "Range: [0,) in integer",
        ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_PARAM(errsim_ddl_major_delay_time, TIME, OB_CLUSTER_PARAMETER, "0s", "[0s,3600s]",
        "ddl create major sstable delay time in errsim mode, Range [0s,3600s]. "
        "The default value is 120s",
        ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_PARAM(errsim_test_tablet_id, INT, OB_CLUSTER_PARAMETER, "0", "[0,)",
        "test tablet id in errsim mode, for error injection"
        "Range: [0,) in integer",
        ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_PARAM(errsim_backup_table_list_batch_size, INT, OB_CLUSTER_PARAMETER, "20000", "[1,)",
        "batch size of table list items in errsim mode"
        "Range: [1,) in integer",
        ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_PARAM(enable_quick_restore_remove_backup_dest_test, BOOL, OB_CLUSTER_PARAMETER, "False",
         "when remove backup dest test mode is enabled, io from backup will "
         "resturn OB_EAGAIN",
         ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_PARAM(backup_errsim_task_server_addr, STR, OB_CLUSTER_PARAMETER, "",
        "the server addr that backup task send to when in errsim mode",
        ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_PARAM(errsim_allow_force_archive_threshold, TIME, OB_CLUSTER_PARAMETER, "600s", "[1s,2h]",
                "force stop archive threshold, Range: [1s,2h]",
                ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_PARAM(errsim_migration_tablet_id, INT, OB_CLUSTER_PARAMETER, "0", "[0,)",
        "the tablet id that migration want to insert error"
        "Range: [0,) in integer",
        ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_PARAM(errsim_max_ddl_sstable_count, INT, OB_CLUSTER_PARAMETER, "0", "[0,)",
        "max ddl sstable count in errsim mode"
        "Range: [0,) in integer",
        ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_PARAM(errsim_max_ddl_block_count, INT, OB_CLUSTER_PARAMETER, "0", "[0,)",
        "max ddl block count in errsim mode"
        "Range: [0,) in integer",
        ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_PARAM(errsim_migration_src_server_addr, STR, OB_CLUSTER_PARAMETER, "",
        "the server dest ls choose as src when in errsim mode",
        ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_PARAM(errsim_migration_dest_server_addr, STR, OB_CLUSTER_PARAMETER, "",
        "the migration dest in errsim mode",
        ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_PARAM(errsim_migration_ls_id, INT, OB_CLUSTER_PARAMETER, "0", "[0,)",
        "errsim migration ls id. Range: [0,) in integer",
        ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_PARAM(errsim_transfer_backfill_server_addr, STR, OB_CLUSTER_PARAMETER, "",
        "the server addr that transfer backfill forbid to execute to when in errsim mode",
        ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_PARAM(errsim_transfer_backfill_error_time, TIME, OB_CLUSTER_PARAMETER, "0", "[0s,1h]",
        "the duration of the error happened to transfer backfill. "
        "Range: [0s, 1h] in duration",
        ObParameterAttr(Section::TENANT, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_PARAM(errsim_module_types, STR, OB_CLUSTER_PARAMETER, "",
             "set module list for errsim error",
             ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_PARAM(errsim_module_error_percentage, DBL, OB_CLUSTER_PARAMETER, "0", "[0,100]",
        "the percentage of the error happened to errsim module. "
        "Range: [0, 100] in percentage",
        ObParameterAttr(Section::TENANT, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE))

DEF_PARAM(block_transfer_out_replay, BOOL, OB_CLUSTER_PARAMETER, "False",
         "errsim to block transfer out clog replay",
         ObParameterAttr(Section::TENANT, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_PARAM(allow_transfer_backfill, BOOL, OB_CLUSTER_PARAMETER, "True",
          "errsim to allow transfer backfill",
          ObParameterAttr(Section::TENANT, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_PARAM(_errsim_ha_diagnose_history_recycle_interval, TIME, OB_CLUSTER_PARAMETER, "0", "[0s, 180d]",
         "The recycle interval time of diagnostic history data. Range: [0s, 180d]",
         ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_PARAM(errsim_transfer_diagnose_server_wait_time, TIME, OB_CLUSTER_PARAMETER, "5m", "[1s,1h]",
        "the wakeup wait time of the transfer diagnose server. "
        "Range: [0s, 1h]",
        ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_PARAM(palf_inject_receive_log_error_zone, STR, OB_CLUSTER_PARAMETER, "", "specifies the zone name that palf module want to inject error when receive log",
        ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_PARAM(migrate_check_member_list_error_zone, STR, OB_CLUSTER_PARAMETER, "", "specifies the zone name that migrate want to inject error when change member list",
        ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_PARAM(errsim_backup_task_batch_size, INT, OB_CLUSTER_PARAMETER, "0", "[0,)",
        "the batch size backup task receive in errsim mode"
        "Range: [0,) in integer",
        ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_PARAM(errsim_delay_gc_interval, TIME, OB_CLUSTER_PARAMETER, "30m", "[0,)",
        "delay gc interval in errsim mode"
         "Range: [0, +∞)",
         ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_PARAM(errsim_max_key_set_size, CAP, OB_CLUSTER_PARAMETER, "2M", "[0M,)",
        "max key set size, it used to test migrating warmup rpc reconnect"
        "Range: [0M,)",
        ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_PARAM(errsim_rebuild_ls_id, INT, OB_CLUSTER_PARAMETER, "0", "[0,)",
        "rebuild ls id. Range: [0,) in integer",
        ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_PARAM(errsim_rebuild_addr, STR, OB_CLUSTER_PARAMETER, "",
        "rebuild addr (ip:port)",
        ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_PARAM(errsim_restore_ls_id, INT, OB_CLUSTER_PARAMETER, "0", "[0,)",
        "the ls id that restore want to insert error"
        "Range: [0,) in integer",
        ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_PARAM(errsim_ls_restore_status, INT, OB_CLUSTER_PARAMETER, "0", "[0,)",
        "the ls restore status that restore want to insert error"
        "Range: [0,) in integer",
        ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_PARAM(errsim_ls_backup_create_task_failed_round, INT, OB_CLUSTER_PARAMETER, "0", "[0,)",
        "Control task creation failures in a specific round." 
        "Range: [0,) in integer",
        ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_PARAM(errsim_ls_backup_push_child_dag_failed_round, INT, OB_CLUSTER_PARAMETER, "0", "[0,)",
