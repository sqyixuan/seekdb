...
ObCheckRestorePreconditionArg::ObCheckRestorePreconditionArg()
  : tenant_id_(OB_INVALID_ID),
    ls_id_()
{
}

bool ObCheckRestorePreconditionArg::is_valid() const
{
  return OB_INVALID_ID != tenant_id_ && ls_id_.is_valid();
}

OB_SERIALIZE_MEMBER(ObCheckRestorePreconditionArg, tenant_id_, ls_id_);
...
ObStandbyCopyTabletInfoArg::ObStandbyCopyTabletInfoArg()
  : tablet_id_list_()
{
}

ObStandbyCopySSTableMacroRangeInfoArg::ObStandbyCopySSTableMacroRangeInfoArg()
  : tablet_id_(),
...
bool ObStandbyCopySSTableMacroRangeInfoArg::is_valid() const
{
  return tablet_id_.is_valid()
...
int ObStandbyCopySSTableMacroRangeInfoArg::assign(const ObStandbyCopySSTableMacroRangeInfoArg &arg)
{
  int ret = OB_SUCCESS;
  if (!arg.is_valid()) {
...
ObStandbyCopyMacroBlockRangeArg::ObStandbyCopyMacroBlockRangeArg()
  : table_key_(),
    data_version_(0),
    backfill_tx_scn_(SCN::min_scn()),
    copy_macro_range_info_(),
...
bool ObStandbyCopyMacroBlockRangeArg::is_valid() const
{
...
OB_SERIALIZE_MEMBER(ObStandbyCopyTabletInfoArg, tablet_id_list_);
OB_SERIALIZE_MEMBER(ObStandbyCopySSTableMacroRangeInfoArg, tablet_id_, copy_table_key_array_, macro_range_max_marco_count_);
OB_SERIALIZE_MEMBER(ObStandbyCopyMacroBlockRangeArg, table_key_, data_version_, backfill_tx_scn_, copy_macro_range_info_, copy_macro_block_infos_);
