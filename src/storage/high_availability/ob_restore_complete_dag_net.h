...
{
public:
  explicit ObInitialCompleteRestoreDag(const share::ObDagType::ObDagTypeEnum &dag_type);
...
{
public:
  explicit ObWaitDataReadyRestoreDag(const share::ObDagType::ObDagTypeEnum &dag_type);
...
{
public:
  explicit ObFinishCompleteRestoreDag(const share::ObDagType::ObDagTypeEnum &dag_type);
