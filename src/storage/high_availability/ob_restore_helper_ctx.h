...
enum ObRestoreHelperCtxType
{
  RESTORE_HELPER_CTX_NONE = 0,
  RESTORE_HELPER_CTX_LS_VIEW = 1,
  RESTORE_HELPER_CTX_SSTABLE_INFO = 2,
  RESTORE_HELPER_CTX_SSTABLE_MACRO_RANGE =3,
  RESTORE_HELPER_CTX_MACRO_BLOCK =4,
  RESTORE_HELPER_CTX_TABLET_INFO = 5,
  RESTORE_HELPER_CTX_MAX
};

class ObIRestoreHelperCtx
{
public:
...
class ObRestoreHelperLSViewCtx final : public ObIRestoreHelperCtx
{
public:
...
class ObRestoreHelperSSTableInfoCtx final : public ObIRestoreHelperCtx
{
public:
...
class ObRestoreHelperSSTableMacroRangeCtx final : public ObIRestoreHelperCtx
{
public:
...
class ObRestoreHelperMacroBlockCtx final : public ObIRestoreHelperCtx
{
public:
