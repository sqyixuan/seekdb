...
static const int64_t DEFAULT_RWLOCK_TIMEOUT_US = 24LL * 3600 * 1000 * 1000;  // 1 day
...
int ObOBJLock::get_other_trans_lock_mode_(const uint64_t lock_mode_cnt_in_same_trans[],
