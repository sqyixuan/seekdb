...
public:
  ...
  // create a LS for standby restore
  // The LS is created with RESTORE_TENANT_ROLE and RESTORE_DOING status,
  // and will be converted to STANDBY after restore completes.
...
private:
  ...
  int create_ls_(const ObTenantRole &tenant_role);
