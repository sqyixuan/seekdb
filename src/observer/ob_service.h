...
private:
  ...
  int start_schema_refresh();
  int setup_standby_log_sync(const common::ObAddr &primary_addr);
...
private:
  ...
  // Standby schema refresh trigger
  share::schema::ObStandbySchemaRefreshTrigger schema_refresh_trigger_;
