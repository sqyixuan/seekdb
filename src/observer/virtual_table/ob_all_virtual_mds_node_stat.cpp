                                                       ...
                                                       common::ObNewRow &row)
{
  ...
  for (int64_t i = 0; OB_SUCC(ret) && i < count; ++i) {
    ...
    switch (col_id) {
      ...
      case OB_APP_MIN_COLUMN_ID + 3: {// user_key
      ...
      case OB_APP_MIN_COLUMN_ID + 4: {// version_idx
        cur_row_.cells_[i].set_int(node_info.version_idx_);
        break;
      }
      case OB_APP_MIN_COLUMN_ID + 5: {// writer_type
        int64_t pos = 0;
      ...
      case OB_APP_MIN_COLUMN_ID + 12: {// state
        int64_t pos = 0;
      ...
      case OB_APP_MIN_COLUMN_ID + 13: {// position
        int64_t pos = 0;
      ...
      case OB_APP_MIN_COLUMN_ID + 14: {// user_data
