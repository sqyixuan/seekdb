...
ObAllVirtualExternalLocationListFile::ObAllVirtualExternalLocationListFile()
...
void ObAllVirtualExternalLocationListFile::reset()
{
  ObVirtualTableScannerIterator::reset();
}

int ObAllVirtualExternalLocationListFile::inner_open()
{
  int ret = OB_SUCCESS;
...
int ObAllVirtualExternalLocationListFile::inner_get_next_row(common::ObNewRow *&row)
{
  int ret = OB_SUCCESS;
...
int ObAllVirtualExternalLocationListFile::resolve_param(uint64_t &location_id, ObString &sub_path, ObString &pattern)
{
  int ret = OB_SUCCESS;
  for (int64_t i = 0;
