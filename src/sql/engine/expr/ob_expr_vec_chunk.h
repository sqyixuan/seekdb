 ...
 */
 ...
 namespace sql
 {
 class ObExprVecChunk : public ObFuncExprOperator
 {
 public:
   explicit ObExprVecChunk(common::ObIAllocator &alloc);
   virtual ~ObExprVecChunk() {}
 ...
 private :
   //disallow copy
   DISALLOW_COPY_AND_ASSIGN(ObExprVecChunk);
 };
 }
 }
 #endif /* OCEANBASE_SRC_SQL_ENGINE_EXPR_OB_EXPR_VEC_CHUNK_H_ */
