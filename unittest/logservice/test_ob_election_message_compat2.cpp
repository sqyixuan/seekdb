...
TEST_F(TestElectionMsgCompat2, new_to_new_real_new) {
  ...
  palf::election::ElectionAcceptResponseMsg msg_response_src(ObAddr(ObAddr::VER::IPV4, "127.0.0.1", 1), 1, config_version,  LsBiggestMinClusterVersionEverSeen(CLUSTER_VERSION_1_0_0_0), msg_request_dst);
