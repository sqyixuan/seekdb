...
update t1 set long_text=repeat('d', 5331648), long_blob=repeat('c', 11534336) where pk=6;
...
update t1 set medium_text=repeat('e', 11534336), medium_blob=repeat('f', 6777216), long_text=repeat('g', 6777216), long_blob=repeat('h', 6777216) where pk=6;
...
update t1 set long_text=repeat('4', 30331648) where pk = 8;
commit;
...
insert into t2 values (5, repeat('1', 256), repeat('2', 256), repeat('3', 65536), repeat('4', 65536), repeat('5', 6777216), repeat('6', 6777216), repeat('7', 3631488), repeat('8', 3631488));
insert into t3 values (5, repeat('1', 256), repeat('2', 256), repeat('3', 65536), repeat('4', 65536), repeat('5', 6777216), repeat('6', 6777216), repeat('7', 3631488), repeat('8', 3631488));
commit;
