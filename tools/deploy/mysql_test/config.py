...
# which relate to this configure file.
"result-dir" : "r",
# Where do the test cases for liboblog and corresponding results put? Support absolute path and relative path
"oblog-test-dir" : "liboblog_t",
"oblog-result-dir" : "liboblog_r",
