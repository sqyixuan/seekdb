...
create table type_t(int_c INT primary key default 1,
                    smallint_c SMALLINT,
                    integer_c INTEGER,
                    float_c decimal(10,5),
                    double_c decimal(10,5),
...
INSERT into type_t values(0, 0, 0, 0.1, 0.1, 0.1, 'goodman', 'goodman', 'goodman', '2015-02-01 02:02:02');
INSERT into type_t values(1, 1, 1, 0.11, 0.11, 0.11, 'good', 'good', 'good', '2015-01-01 02:02:02');
INSERT into type_t values(2, 2, 2, 1.11, 1.11, 1.11, 'helloworld', 'helloworld', 'helloworld', '2015-01-06 00:00:00');
insert into type_t(int_c, varchar_c, date_c) values(3, '2015-01-06','2015-11-11 00:00:00');
insert into type_t(int_c, varchar_c) values(4, '2015-01-01');
insert into type_t(int_c, varchar_c) values(5, '1');
