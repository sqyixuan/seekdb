...
-- create table s01xs01(pk1 varchar(65536) primary key, a1 varchar(65536));
...
-- ) TABLET_MAX_SIZE = 4194304, TABLET_BLOCK_SIZE = 4096, USE_BLOOM_FILTER = FALSE;
...
-- , time_out DATETIME
-- , time_number INT
-- , opt_gmt_create DATETIME
-- , area_id INT
-- , feature VARCHAR
-- , flag INT
-- , store_code VARCHAR
-- , reserved_by_cache INT
-- , timeout_status INT
-- , own_sign VARCHAR
-- , redo_count INT
-- , store_quantity INT
