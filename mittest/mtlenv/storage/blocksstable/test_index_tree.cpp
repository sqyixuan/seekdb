                                         ...
                                         ObSSTableIndexBuilder *sstable_builder)
{
  ...
  ASSERT_EQ(OB_SUCCESS, desc.init(is_ddl, table_schema_, ObLSID(1), ObTabletID(1), 
      MAJOR_MERGE, SNAPSHOT_VERSION, DATA_CURRENT_VERSION, false/*micro_index_clustered*/, 0/*transfer_seq*/, 0/*concurrent_cnt*/));
  ...
  ASSERT_EQ(OB_SUCCESS, data_desc.init(is_ddl, table_schema_, ObLSID(1), ObTabletID(1),
                    ...
                    0/*concurrent_cnt*/, scn, &cg_schema, 0));
...
TEST_F(TestIndexTree, test_single_row_desc)
{
  ...
  sstable_builder3.index_store_desc_.get_desc().static_desc_->major_working_cluster_version_ = DATA_VERSION_1_0_0_0;
  sstable_builder3.container_store_desc_.static_desc_->major_working_cluster_version_ = DATA_VERSION_1_0_0_0;
...
TEST_F(TestIndexTree, test_close_with_old_schema)
{
  ...
  OK(index_desc.init(false/*is_ddl*/, table_schema_, ObLSID(1), ObTabletID(1), MAJOR_MERGE, 
                     ...
                     table_schema_.get_micro_index_clustered(), 0/*transfer_seq*/, 0/*concurrent_cnt*/));
  index_desc.static_desc_.major_working_cluster_version_ = DATA_VERSION_1_0_0_0;
