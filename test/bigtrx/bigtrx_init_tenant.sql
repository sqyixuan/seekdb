...
use oceanbase;
create resource unit box1 max_cpu 5, memory_size 40294967296, log_disk_size='30G',max_iops=1000000;
...
alter system set log_storage_warning_tolerance_time='100s';
