...
use oceanbase;
create resource unit box1 max_cpu 6, memory_size 12647483648, log_disk_size='30G',max_iops=1000000;
...
call create_oracle_tenant('base');

select sleep(30);

call create_oracle_tenant('remote');
