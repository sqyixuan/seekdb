...
#ifdef _WIN32
    fprintf(stderr, "[DIAG] AChunkMgr::alloc_chunk FAILED, size=%lu, hold=%ld, limit=%ld, hard_limit=%ld\n",
            (unsigned long)size, (long)hold_, (long)limit_, (long)hard_limit_); fflush(stderr);
#endif
