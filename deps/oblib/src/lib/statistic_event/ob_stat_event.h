...
STAT_EVENT_ADD_DEF(REDISAPI_LINDEX_COUNT, "redis lindex count", ObStatClassIds::REDISAPI, 191501, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_LINDEX_TIME, "redis lindex time", ObStatClassIds::REDISAPI, 191502, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_LSET_COUNT, "redis lset count", ObStatClassIds::REDISAPI, 191503, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_LSET_TIME, "redis lset time", ObStatClassIds::REDISAPI, 191504, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_LRANGE_COUNT, "redis lrange count", ObStatClassIds::REDISAPI, 191505, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_LRANGE_TIME, "redis lrange time", ObStatClassIds::REDISAPI, 191506, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_LTRIM_COUNT, "redis ltrim count", ObStatClassIds::REDISAPI, 191507, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_LTRIM_TIME, "redis ltrim time", ObStatClassIds::REDISAPI, 191508, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_LPUSH_COUNT, "redis lpush count", ObStatClassIds::REDISAPI, 191509, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_LPUSH_TIME, "redis lpush time", ObStatClassIds::REDISAPI, 191510, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_LPUSHX_COUNT, "redis lpushx count", ObStatClassIds::REDISAPI, 191511, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_LPUSHX_TIME, "redis lpushx time", ObStatClassIds::REDISAPI, 191512, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_RPUSH_COUNT, "redis rpush count", ObStatClassIds::REDISAPI, 191513, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_RPUSH_TIME, "redis rpush time", ObStatClassIds::REDISAPI, 191514, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_RPUSHX_COUNT, "redis rpushx count", ObStatClassIds::REDISAPI, 191515, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_RPUSHX_TIME, "redis rpushx time", ObStatClassIds::REDISAPI, 191516, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_LPOP_COUNT, "redis lpop count", ObStatClassIds::REDISAPI, 191517, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_LPOP_TIME, "redis lpop time", ObStatClassIds::REDISAPI, 191518, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_RPOP_COUNT, "redis rpop count", ObStatClassIds::REDISAPI, 191519, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_RPOP_TIME, "redis rpop time", ObStatClassIds::REDISAPI, 191520, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_LREM_COUNT, "redis lrem count", ObStatClassIds::REDISAPI, 191521, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_LREM_TIME, "redis lrem time", ObStatClassIds::REDISAPI, 191522, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_RPOPLPUSH_COUNT, "redis rpoplpush count", ObStatClassIds::REDISAPI, 191523, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_RPOPLPUSH_TIME, "redis rpoplpush time", ObStatClassIds::REDISAPI, 191524, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_LINSERT_COUNT, "redis linsert count", ObStatClassIds::REDISAPI, 191525, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_LINSERT_TIME, "redis linsert time", ObStatClassIds::REDISAPI, 191526, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_LLEN_COUNT, "redis llen count", ObStatClassIds::REDISAPI, 191527, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_LLEN_TIME, "redis llen time", ObStatClassIds::REDISAPI, 191528, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_SDIFF_COUNT, "redis sdiff count", ObStatClassIds::REDISAPI, 191529, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_SDIFF_TIME, "redis sdiff time", ObStatClassIds::REDISAPI, 191530, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_SDIFFSTORE_COUNT, "redis sdiffstore count", ObStatClassIds::REDISAPI, 191531, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_SDIFFSTORE_TIME, "redis sdiffstore time", ObStatClassIds::REDISAPI, 191532, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_SINTER_COUNT, "redis sinter count", ObStatClassIds::REDISAPI, 191533, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_SINTER_TIME, "redis sinter time", ObStatClassIds::REDISAPI, 191534, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_SINTERSTORE_COUNT, "redis sinterstore count", ObStatClassIds::REDISAPI, 191535, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_SINTERSTORE_TIME, "redis sinterstore time", ObStatClassIds::REDISAPI, 191536, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_SUNION_COUNT, "redis sunion count", ObStatClassIds::REDISAPI, 191537, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_SUNION_TIME, "redis sunion time", ObStatClassIds::REDISAPI, 191538, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_SUNIONSTORE_COUNT, "redis sunionstore count", ObStatClassIds::REDISAPI, 191539, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_SUNIONSTORE_TIME, "redis sunionstore time", ObStatClassIds::REDISAPI, 191540, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_SADD_COUNT, "redis sadd count", ObStatClassIds::REDISAPI, 191541, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_SADD_TIME, "redis sadd time", ObStatClassIds::REDISAPI, 191542, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_SCARD_COUNT, "redis scard count", ObStatClassIds::REDISAPI, 191543, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_SCARD_TIME, "redis scard time", ObStatClassIds::REDISAPI, 191544, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_SISMEMBER_COUNT, "redis sismember count", ObStatClassIds::REDISAPI, 191545, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_SISMEMBER_TIME, "redis sismember time", ObStatClassIds::REDISAPI, 191546, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_SMEMBERS_COUNT, "redis smembers count", ObStatClassIds::REDISAPI, 191547, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_SMEMBERS_TIME, "redis smembers time", ObStatClassIds::REDISAPI, 191548, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_SMOVE_COUNT, "redis smove count", ObStatClassIds::REDISAPI, 191549, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_SMOVE_TIME, "redis smove time", ObStatClassIds::REDISAPI, 191550, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_SPOP_COUNT, "redis spop count", ObStatClassIds::REDISAPI, 191551, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_SPOP_TIME, "redis spop time", ObStatClassIds::REDISAPI, 191552, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_SRANDMEMBER_COUNT, "redis srandmember count", ObStatClassIds::REDISAPI, 191553, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_SRANDMEMBER_TIME, "redis srandmember time", ObStatClassIds::REDISAPI, 191554, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_SREM_COUNT, "redis srem count", ObStatClassIds::REDISAPI, 191555, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_SREM_TIME, "redis srem time", ObStatClassIds::REDISAPI, 191556, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_ZADD_COUNT, "redis zadd count", ObStatClassIds::REDISAPI, 191557, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_ZADD_TIME, "redis zadd time", ObStatClassIds::REDISAPI, 191558, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_ZCARD_COUNT, "redis zcard count", ObStatClassIds::REDISAPI, 191559, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_ZCARD_TIME, "redis zcard time", ObStatClassIds::REDISAPI, 191560, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_ZREM_COUNT, "redis zrem count", ObStatClassIds::REDISAPI, 191561, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_ZREM_TIME, "redis zrem time", ObStatClassIds::REDISAPI, 191562, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_ZINCRBY_COUNT, "redis zincrby count", ObStatClassIds::REDISAPI, 191563, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_ZINCRBY_TIME, "redis zincrby time", ObStatClassIds::REDISAPI, 191564, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_ZSCORE_COUNT, "redis zscore count", ObStatClassIds::REDISAPI, 191565, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_ZSCORE_TIME, "redis zscore time", ObStatClassIds::REDISAPI, 191566, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_ZRANK_COUNT, "redis zrank count", ObStatClassIds::REDISAPI, 191567, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_ZRANK_TIME, "redis zrank time", ObStatClassIds::REDISAPI, 191568, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_ZREVRANK_COUNT, "redis zrevrank count", ObStatClassIds::REDISAPI, 191569, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_ZREVRANK_TIME, "redis zrevrank time", ObStatClassIds::REDISAPI, 191570, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_ZRANGE_COUNT, "redis zrange count", ObStatClassIds::REDISAPI, 191571, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_ZRANGE_TIME, "redis zrange time", ObStatClassIds::REDISAPI, 191572, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_ZREVRANGE_COUNT, "redis zrevrange count", ObStatClassIds::REDISAPI, 191573, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_ZREVRANGE_TIME, "redis zrevrange time", ObStatClassIds::REDISAPI, 191574, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_ZREMRANGEBYRANK_COUNT, "redis zremrangebyrank count", ObStatClassIds::REDISAPI, 191575, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_ZREMRANGEBYRANK_TIME, "redis zremrangebyrank time", ObStatClassIds::REDISAPI, 191576, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_ZCOUNT_COUNT, "redis zcount count", ObStatClassIds::REDISAPI, 191577, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_ZCOUNT_TIME, "redis zcount time", ObStatClassIds::REDISAPI, 191578, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_ZRANGEBYSCORE_COUNT, "redis zrangebyscore count", ObStatClassIds::REDISAPI, 191579, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_ZRANGEBYSCORE_TIME, "redis zrangebyscore time", ObStatClassIds::REDISAPI, 191580, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_ZREVRANGEBYSCORE_COUNT, "redis zrevrangebyscore count", ObStatClassIds::REDISAPI, 191581, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_ZREVRANGEBYSCORE_TIME, "redis zrevrangebyscore time", ObStatClassIds::REDISAPI, 191582, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_ZREMRANGEBYSCORE_COUNT, "redis zremrangebyscore count", ObStatClassIds::REDISAPI, 191583, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_ZREMRANGEBYSCORE_TIME, "redis zremrangebyscore time", ObStatClassIds::REDISAPI, 191584, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_ZINTERSTORE_COUNT, "redis zinterstore count", ObStatClassIds::REDISAPI, 191585, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_ZINTERSTORE_TIME, "redis zinterstore time", ObStatClassIds::REDISAPI, 191586, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_ZUNIONSTORE_COUNT, "redis zunionstore count", ObStatClassIds::REDISAPI, 191587, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_ZUNIONSTORE_TIME, "redis zunionstore time", ObStatClassIds::REDISAPI, 191588, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_HSET_COUNT, "redis hset count", ObStatClassIds::REDISAPI, 191589, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_HSET_TIME, "redis hset time", ObStatClassIds::REDISAPI, 191590, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_HMSET_COUNT, "redis hmset count", ObStatClassIds::REDISAPI, 191591, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_HMSET_TIME, "redis hmset time", ObStatClassIds::REDISAPI, 191592, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_HSETNX_COUNT, "redis hsetnx count", ObStatClassIds::REDISAPI, 191593, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_HSETNX_TIME, "redis hsetnx time", ObStatClassIds::REDISAPI, 191594, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_HGET_COUNT, "redis hget count", ObStatClassIds::REDISAPI, 191595, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_HGET_TIME, "redis hget time", ObStatClassIds::REDISAPI, 191596, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_HMGET_COUNT, "redis hmget count", ObStatClassIds::REDISAPI, 191597, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_HMGET_TIME, "redis hmget time", ObStatClassIds::REDISAPI, 191598, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_HGETALL_COUNT, "redis hgetall count", ObStatClassIds::REDISAPI, 191599, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_HGETALL_TIME, "redis hgetall time", ObStatClassIds::REDISAPI, 191600, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_HVALS_COUNT, "redis hvals count", ObStatClassIds::REDISAPI, 191601, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_HVALS_TIME, "redis hvals time", ObStatClassIds::REDISAPI, 191602, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_HKEYS_COUNT, "redis hkeys count", ObStatClassIds::REDISAPI, 191603, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_HKEYS_TIME, "redis hkeys time", ObStatClassIds::REDISAPI, 191604, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_HEXISTS_COUNT, "redis hexists count", ObStatClassIds::REDISAPI, 191605, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_HEXISTS_TIME, "redis hexists time", ObStatClassIds::REDISAPI, 191606, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_HDEL_COUNT, "redis hdel count", ObStatClassIds::REDISAPI, 191607, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_HDEL_TIME, "redis hdel time", ObStatClassIds::REDISAPI, 191608, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_HINCRBY_COUNT, "redis hincrby count", ObStatClassIds::REDISAPI, 191609, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_HINCRBY_TIME, "redis hincrby time", ObStatClassIds::REDISAPI, 191610, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_HINCRBYFLOAT_COUNT, "redis hincrbyfloat count", ObStatClassIds::REDISAPI, 191611, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_HINCRBYFLOAT_TIME, "redis hincrbyfloat time", ObStatClassIds::REDISAPI, 191612, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_HLEN_COUNT, "redis hlen count", ObStatClassIds::REDISAPI, 191613, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_HLEN_TIME, "redis hlen time", ObStatClassIds::REDISAPI, 191614, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_GETSET_COUNT, "redis getset count", ObStatClassIds::REDISAPI, 191615, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_GETSET_TIME, "redis getset time", ObStatClassIds::REDISAPI, 191616, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_SETBIT_COUNT, "redis setbit count", ObStatClassIds::REDISAPI, 191617, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_SETBIT_TIME, "redis setbit time", ObStatClassIds::REDISAPI, 191618, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_INCR_COUNT, "redis incr count", ObStatClassIds::REDISAPI, 191619, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_INCR_TIME, "redis incr time", ObStatClassIds::REDISAPI, 191620, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_INCRBY_COUNT, "redis incrby count", ObStatClassIds::REDISAPI, 191621, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_INCRBY_TIME, "redis incrby time", ObStatClassIds::REDISAPI, 191622, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_DECR_COUNT, "redis decr count", ObStatClassIds::REDISAPI, 191623, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_DECR_TIME, "redis decr time", ObStatClassIds::REDISAPI, 191624, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_DECRBY_COUNT, "redis decrby count", ObStatClassIds::REDISAPI, 191625, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_DECRBY_TIME, "redis decrby time", ObStatClassIds::REDISAPI, 191626, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_APPEND_COUNT, "redis append count", ObStatClassIds::REDISAPI, 191627, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_APPEND_TIME, "redis append time", ObStatClassIds::REDISAPI, 191628, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_BITCOUNT_COUNT, "redis bitcount count", ObStatClassIds::REDISAPI, 191629, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_BITCOUNT_TIME, "redis bitcount time", ObStatClassIds::REDISAPI, 191630, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_GET_COUNT, "redis get count", ObStatClassIds::REDISAPI, 191631, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_GET_TIME, "redis get time", ObStatClassIds::REDISAPI, 191632, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_GETBIT_COUNT, "redis getbit count", ObStatClassIds::REDISAPI, 191633, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_GETBIT_TIME, "redis getbit time", ObStatClassIds::REDISAPI, 191634, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_GETRANGE_COUNT, "redis getrange count", ObStatClassIds::REDISAPI, 191635, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_GETRANGE_TIME, "redis getrange time", ObStatClassIds::REDISAPI, 191636, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_INCRBYFLOAT_COUNT, "redis incrbyfloat count", ObStatClassIds::REDISAPI, 191637, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_INCRBYFLOAT_TIME, "redis incrbyfloat time", ObStatClassIds::REDISAPI, 191638, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_MGET_COUNT, "redis mget count", ObStatClassIds::REDISAPI, 191639, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_MGET_TIME, "redis mget time", ObStatClassIds::REDISAPI, 191640, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_MSET_COUNT, "redis mset count", ObStatClassIds::REDISAPI, 191641, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_MSET_TIME, "redis mset time", ObStatClassIds::REDISAPI, 191642, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_SET_COUNT, "redis set count", ObStatClassIds::REDISAPI, 191643, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_SET_TIME, "redis set time", ObStatClassIds::REDISAPI, 191644, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_PSETEX_COUNT, "redis psetex count", ObStatClassIds::REDISAPI, 191645, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_PSETEX_TIME, "redis psetex time", ObStatClassIds::REDISAPI, 191646, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_SETEX_COUNT, "redis setex count", ObStatClassIds::REDISAPI, 191647, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_SETEX_TIME, "redis setex time", ObStatClassIds::REDISAPI, 191648, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_SETNX_COUNT, "redis setnx count", ObStatClassIds::REDISAPI, 191649, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_SETNX_TIME, "redis setnx time", ObStatClassIds::REDISAPI, 191650, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_SETRANGE_COUNT, "redis setrange count", ObStatClassIds::REDISAPI, 191651, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_SETRANGE_TIME, "redis setrange time", ObStatClassIds::REDISAPI, 191652, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_STRLEN_COUNT, "redis strlen count", ObStatClassIds::REDISAPI, 191653, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_STRLEN_TIME, "redis strlen time", ObStatClassIds::REDISAPI, 191654, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_TTL_COUNT, "redis ttl count", ObStatClassIds::REDISAPI, 191655, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_TTL_TIME, "redis ttl time", ObStatClassIds::REDISAPI, 191656, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_PTTL_COUNT, "redis pttl count", ObStatClassIds::REDISAPI, 191657, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_PTTL_TIME, "redis pttl time", ObStatClassIds::REDISAPI, 191658, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_EXPIRE_COUNT, "redis expire count", ObStatClassIds::REDISAPI, 191659, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_EXPIRE_TIME, "redis expire time", ObStatClassIds::REDISAPI, 191660, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_PEXPIRE_COUNT, "redis pexpire count", ObStatClassIds::REDISAPI, 191661, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_PEXPIRE_TIME, "redis pexpire time", ObStatClassIds::REDISAPI, 191662, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_EXPIREAT_COUNT, "redis expireat count", ObStatClassIds::REDISAPI, 191663, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_EXPIREAT_TIME, "redis expireat time", ObStatClassIds::REDISAPI, 191664, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_PEXPIREAT_COUNT, "redis pexpireat count", ObStatClassIds::REDISAPI, 191665, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_PEXPIREAT_TIME, "redis pexpireat time", ObStatClassIds::REDISAPI, 191666, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_DEL_COUNT, "redis del count", ObStatClassIds::REDISAPI, 191667, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_DEL_TIME, "redis del time", ObStatClassIds::REDISAPI, 191668, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_EXISTS_COUNT, "redis exists count", ObStatClassIds::REDISAPI, 191669, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_EXISTS_TIME, "redis exists time", ObStatClassIds::REDISAPI, 191670, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_TYPE_COUNT, "redis type count", ObStatClassIds::REDISAPI, 191671, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_TYPE_TIME, "redis type time", ObStatClassIds::REDISAPI, 191672, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_PERSIST_COUNT, "redis persist count", ObStatClassIds::REDISAPI, 191673, true, true, true)
STAT_EVENT_ADD_DEF(REDISAPI_PERSIST_TIME, "redis persist time", ObStatClassIds::REDISAPI, 191674, true, true, true)
