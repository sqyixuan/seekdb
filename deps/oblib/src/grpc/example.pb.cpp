...
const char descriptor_table_protodef_example_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "\001 \001(\t2\232\002\n\016ExampleService\0226\n\010SayHello\022\025.e"
  "xample.HelloRequest\032\023.example.HelloReply"
  "\022D\n\024SayHelloServerStream\022\025.example.Hello"
  "Request\032\023.example.HelloReply0\001\022D\n\024SayHel"
  "loClientStream\022\025.example.HelloRequest\032\023."
  "example.HelloReply(\001\022D\n\022SayHelloBidiStre"
  "am\022\025.example.HelloRequest\032\023.example.Hell"
  "oReply(\0010\001b\006proto3"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_example_2eproto = {
  false, false, 378, descriptor_table_protodef_example_2eproto, "example.proto", 
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          ...
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "example.HelloReply.message"));
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
