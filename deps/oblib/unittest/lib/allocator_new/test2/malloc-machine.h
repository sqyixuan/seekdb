...
#define test_mutex_init(m)              ((m)->lock = 0)
static inline int test_mutex_lock(mutex_t *m) {
  int cnt = 0, r;
  struct timespec tm;
...
static inline int test_mutex_trylock(mutex_t *m) {
  int r;
...
static inline int test_mutex_unlock(mutex_t *m) {
...
#define test_mutex_init(m)              pthread_mutex_init(m, NULL)
#define test_mutex_lock(m)              pthread_mutex_lock(m)
#define test_mutex_trylock(m)           pthread_mutex_trylock(m)
#define test_mutex_unlock(m)            pthread_mutex_unlock(m)
