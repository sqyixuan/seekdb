...
#ifndef _OCEABASE_ARBSERVER_NORMAL_RPC_QHANDLER_H_
#define _OCEABASE_ARBSERVER_NORMAL_RPC_QHANDLER_H_
...
class ObArbNormalRpcQHandler
    : public rpc::frame::ObiReqQHandler
{
public:
  ObArbNormalRpcQHandler();
  virtual ~ObArbNormalRpcQHandler();
...
private:
  ...
  void *filter_;
  bool is_inited_;
}; // end of class ObArbNormalRpcQHandler

} // end of namespace arbserver
} // end of namespace oceanbase

#endif /* _OCEABASE_ARBSERVER_REQ_QHANDLER_H_ */
