...
public:
  ...
  OB_INLINE share::ObCompactionLocalityCache &get_ls_locality_cache() { return ls_locality_cache_; }
private:
  bool is_inited_;
...
#define MTL_LS_LOCALITY_CACHE MTL(ObTenantCompactionObjMgr *)->get_ls_locality_cache()
