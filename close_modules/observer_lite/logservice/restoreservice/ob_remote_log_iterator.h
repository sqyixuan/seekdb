...
#include "close_modules/observer_lite/logservice/archiveservice/large_buffer_pool.h"
...
private:
  ...
  ObLSID id_;
  LSN start_lsn_;
  LSN cur_lsn_;            // The endpoint LSN of the latest log entry iterated
  share::SCN cur_scn_;     // iteration latest log scn
  LSN end_lsn_;
