...
#include "close_modules/observer_lite/logservice/logfetcher/ob_log_fetcher_ls_ctx_additional_info_factory.h"
#include "close_modules/observer_lite/logservice/logfetcher/ob_log_fetcher_err_handler.h"
#include "close_modules/observer_lite/logservice/logfetcher/ob_log_fetcher_ls_ctx_default_factory.h"
...
private:
  // TODO How does LogFetcher distinguish changes in LogRestoreSource, for example, from tenant A in cluster 1 to tenant B in cluster 2
  // LogFetcher needs to provide an interface, distinguishing different cluster_id, tenant_id
private:
