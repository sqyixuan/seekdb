...
#ifndef OCEANBASE_LOG_FETCHER_LS_FETCH_CTX_H__
#define OCEANBASE_LOG_FETCHER_LS_FETCH_CTX_H__
...
#include "close_modules/observer_lite/logservice/logrouteservice/ob_log_route_service.h" // ObLogRouteService
...
#include "close_modules/observer_lite/logservice/restoreservice/ob_remote_log_iterator.h"  // ObRemoteLogIterator
#include "close_modules/observer_lite/logservice/restoreservice/ob_remote_log_source.h"    // ObRemoteLogParent
...
#include "close_modules/observer_lite/logservice/logfetcher/ob_log_fetcher_err_handler.h" // IObLogErrHandler
#include "close_modules/observer_lite/logservice/cdcservice/ob_cdc_raw_log_req.h"
...
public:
  ...
  // 2. If there is no demand, you can do nothing
  //
  // Note that.
  // 1. The sync() operation is only called by this function.
  //
  ...
  ObILogFetcherLSCtxAddInfo *get_ls_ctx_add_info() { return ls_ctx_add_info_; }
  ...
  double get_tps()
  {
    return NULL == ls_ctx_add_info_ ? 0 : ls_ctx_add_info_->get_tps();
  }
...
#endif /* OCEANBASE_LOG_FETCHER_PART_FETCH_CTX_H__ */
