...
public:
  ...
  /// The allocation and release of elements
...
void ObEasyHazardMap<K, V>::destroy()
{
  inited_ = false;
  valid_count_ = 0;
  // FIXME: Due to EMap depending on EAlloc, but EMap does not have a destroy() function,
  // Therefore, the EAlloc's destroy() function cannot be called here
  // TODO:recycle every element in the Map
}
